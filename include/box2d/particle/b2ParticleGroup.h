...
private:
	...
	mutable float32 m_linearDamping;
	mutable float32 m_angularDamping;
...
{
	return b2Rot_GetAngle(m_transform.q);
}
...
{
	UpdateStatistics();
	return m_linearVelocity + b2CrossSV(m_angularVelocity, worldPoint - m_center);
}
